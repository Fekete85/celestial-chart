// d3-celestial modernizált fork — BSD-3-Clause, lásd LICENSE
...
function geoZoom() {
  ...
  function indul(esemeny) {
    mouse0 = d3.pointer(esemeny, this);
    rotate0 = quaternionFromEuler(projection.rotate());
    var pont = position(projection, mouse0);
  ...
  function zoomol(esemeny) {
    ...
    var mouse1 = d3.pointer(esemeny, this),
        between = rotateBetween(zoom.zoomPoint, position(projection, mouse1));
