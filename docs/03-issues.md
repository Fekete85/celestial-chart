...
| # | Cím | Állapot |
|---|---|---|
| **148** | `horizontal.inverse` missing sign correction | **Reprodukálva és számszerűsítve**: 153/306 pont hibás, max. eltérés 171,4°. A javítás egy sor. Lásd `harness/issue-148-check.mjs` |
